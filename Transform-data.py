...
def transform(df, *args, **kwargs):
    ...
    #Creating passenger count and trip distance dimension table
    ...
    #Creating pickup and dropoff location dimension table
    ...
    #return fact_table, passenger_count_dim, trip_distance_dim
    return {
